...
def look_for_things(myList):
    ...
    for n in myList:
        if n == NUMBER:
            return True
    return False
# the big-O upper bound runtime for the function look_for_things is O(n)
    ...
    for n in myList:
        for m in myList:
            if n - m == NUMBER or m - n == NUMBER:
                return True
    return False
# the big-O upper bound runtime for the function look_for_things is O(n^2)
...
def look_for_all_the_things(myList):
    ...
    for subset in all_subsets:
        if sum(subset) == NUMBER:
            return True
    return False
# the big-O upper bound runtime for the function look_for_things is O(2^n)
